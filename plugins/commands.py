...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/favaio_Links'),
            InlineKeyboardButton('🧩 Source', url='https://google.com')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://google.com'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/favaio_links'),     
        ],
        [
            InlineKeyboardButton("🎞 How to Deploy", url='https://google.com'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://google.com.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
